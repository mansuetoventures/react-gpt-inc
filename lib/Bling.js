...
var Bling = (_temp2 = _class = function (_Component) {
    ...
    _createClass(Bling, [{
        ...
        value: function callMoatPrebidAnalytics(adSlot) {
            ...
            if (window.top.moatPrebidApi && typeof window.top.moatPrebidApi.slotDataAvailable === "function" && window.top.moatPrebidApi.slotDataAvailable() && adSlot.O.indexOf('oop') === -1) {
